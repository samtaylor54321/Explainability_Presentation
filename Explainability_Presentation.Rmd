...
```{r accuracy}
print(" ![](images/accuracy_tradeoff.png)")
```
...
```{r facebook}
print("- ![https://www.theguardian.com/technology/2019/apr/01/why-am-i-seeing-this-new-facebook-tool-to-demystify-news-feed](images/facebook.png) ")
```
